...
このプロジェクトには開発・テスト用の Docker 環境が含まれています。
...
1. **プロジェクトのクローン**
   ...
   ```bash
   git clone https://github.com/JarodBruce/deathmode.git
   cd deathmode
   ```
...
3. **Minecraft サーバーへの接続**

   - Minecraft Java 版 (バージョン **1.16.5**) を起動
   - マルチプレイから `localhost` で接続
...
3. VSCode で実行中のコンテナにアタッチ
4. `/app/plugin-src` フォルダを開いて開発
...
バグ報告や機能要求は [Issues](https://github.com/JarodBruce/deathmode/issues) にお願いします。  
プルリクエストも歓迎です！
